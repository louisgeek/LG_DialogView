package com.louis.lg_dialogview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private CountDownTimer countDownTimer = new CountDownTimer(2 * 1000, 1000) {
        ...
        public void onFinish() {
            ...
            DialogViewManager.hideLoadingDialogAutoAfterTip("加载完成", 1000, new OnAutoHideListener() {
                @Override
...
//                        .setCustomTitleView(dialogTitleTextView)
        ...
        findViewById(R.id.id_btn_tip).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogViewManager.showTipDialog(fragmentActivity, "温馨提示", "提示内容");
            }
        });
        ...
        findViewById(R.id.id_btn_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogViewManager.showEditDialog(fragmentActivity, "输入框", "输入内容", new OnEditBtnClickListener() {
                    @Override
        ...
        findViewById(R.id.id_btn_classic).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogViewManager.showClassicDialog(fragmentActivity, "温馨提示", "提示内容", new OnBtnClickListener() {
                    @Override
     ...
     /*   DialogManager.showEditDialog(this, "温馨提示", "文本输入", new DialogManager.OnEditBtnClickListener() {
        ...
        DialogView dialogView =
                new DialogView.Builder(this)
                        ...
                        .build();
        dialogView.show(getSupportFragmentManager(), "DASDAS");
